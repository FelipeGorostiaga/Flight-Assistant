...
public class Terminal {
    ...
    private String createKML(List<Flight> flights) {
        if(flights.isEmpty())
            return "NotFound";
        ...
        for(Flight flight : flights) {
            ...
            kml.append(createPlacemark(flight, i));
    ...
    private String initializeRoute() {
        return "\n\t\t<Placemark>\n" +
                " \t\t\t<name>route</name>\n" +
    ...
    private String createCamera(double longitude, double latitude) {
        return "\t\t<Camera id=\"ID\"> \n" +
                "  \t\t\t<gx:ViewerOptions>\n" +
    ...
    private String finalizePlacemarks(Airport dest) {
    ...
    private String addRoutePoint(Flight flight, boolean isLast) {
